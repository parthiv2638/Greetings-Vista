...
{
$obj->setSide_Description($_POST["sidedescription"]);
$obj->insert_rec($obj);
}
...
<td>
<input type="text" name="sidedescription" value="<?php echo $Description; ?>"/>
<tr>
<td>
<br>
<br>
...
<?php
$str="<table border='3' class='table table-striped table-mod-2' class='grid-content' class='grid-content-overflow' class='grid' id='datatable_3' class='grid-title' class='pull-left' class='pull-right' height=150 width=200><tr><th>Edit</th><th>Side Description</th></tr>";
$result=$obj->select_rec();

while($row=mysql_fetch_array($result))
{
$str.="<tr><td><a href='Side_Master.php?Id=".$row[0] ."'>Edit</a></td><td><a href='Side_Master.php?Id=".$row[0] ."'> ".$row[1]."</td></tr>";
}
$str.="</table>";
echo "$str";
?>
