...
{
$obj->setGroup_Name($_POST["groupname"]);
$obj->insert_rec($obj);
}
...
<td>
<input class="form-control" type="text" name="groupname" value="<?php echo $Name; ?>"/>
<tr>
<td>
<br>
<br>
...
{
$str.="<tr><td><a href='Group.php?Id=".$row[0] ."'>Edit</a></td><td><a href='Group.php?Id=".$row[0] ."'>".$row[1]."</td></tr>";
}
$str.="</table>";
echo "$str";
?>
